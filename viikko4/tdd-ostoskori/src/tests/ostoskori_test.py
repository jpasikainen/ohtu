...
class TestOstoskori(unittest.TestCase):
    ...
    def test_kahden_saman_tuotteen_lisaamisen_jalkeen_ostoskori_sisaltaa_ostoksen_jolla_sama_nimi_kuin_tuotteella_ja_lukumaara_2(self):
        ...
        self.assertEqual(ostokset, ("Maito", 2))
    
    def test_poista_korista_toinen_kahdesta_samasta_tuotteesta(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
        self.kori.poista_tuote(maito)
        ostokset = self.kori.ostokset()[0]
        self.assertEqual(ostokset, ("Maito", 1))
    
    def test_poista_lisatty_tuote(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.poista_tuote(maito)
        ostokset = self.kori.ostokset()
