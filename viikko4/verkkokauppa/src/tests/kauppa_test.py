...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostos_kahdella_samalla_varaston_tuotteella(self):
        # tehdään toteutus saldo-metodille
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_ostos_kahdella_eri_varaston_tuotteella(self):
        # tehdään toteutus saldo-metodille
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_ostetaan_varastosta_loppunut_tuote(self):
        # tehdään toteutus saldo-metodille
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_aloita_asiointi_alustaa_ostoskorin_ostosten_valissa(self):
        # tehdään toteutus saldo-metodille
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
